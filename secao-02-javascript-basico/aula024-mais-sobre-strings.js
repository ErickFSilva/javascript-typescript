...
console.log(string1.indexOf('texto')); // encontra a posição do texto em pesquisa
console.log(string2.lastIndexOf('e')); // encontra a posição do texto em pesquisa
